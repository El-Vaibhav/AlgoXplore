...
# Plot O(log n)
plt.plot(n, n*log_n, color='blue', linewidth=2, marker='o', markersize=5)  # Blue line with markers

# Customize the plot
plt.title('Graph of O(n*log(n))', color='white')  # Title color
plt.xlabel('n', color='white')  # X-axis label color
plt.ylabel('O(n*log(n))', color='white')  # Y-axis label color
