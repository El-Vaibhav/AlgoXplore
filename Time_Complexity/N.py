...
# Plot O(log n)
plt.plot(n, n, color='blue', linewidth=2, marker='o', markersize=5)  # Blue line with markers

# Customize the plot
plt.title('Graph of O(n)', color='white')  # Title color
plt.xlabel('n', color='white')  # X-axis label color
plt.ylabel('O(n)', color='white')  # Y-axis label color
