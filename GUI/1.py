...
image_path_main =  resource_path("img1.jpg")
...
image_path_small1 = resource_path("small_img1.png")
...
image_small1 = image_small1.resize((IMG_WIDTH, IMG_HEIGHT), Image.LANCZOS)
...
label_small_image1.place(x=200, y=(image_height_main - IMG_HEIGHT) // 1.1)  # Adjust position above button 1
...
frame_buttons1.place(x=200, y=(image_height_main - IMG_HEIGHT) // 1.1 + IMG_HEIGHT + 20)  # Increase space between button and small image1 using +20 
...
image_path_small2 = resource_path("small_img2.jpeg")
...
image_small2 = image_small2.resize((IMG_WIDTH, IMG_HEIGHT), Image.LANCZOS)
...
label_small_image2.place(x=620, y=(image_height_main - IMG_HEIGHT) // 1.1)  # Adjust position above button 2

frame_buttons2 = tk.Frame(root, bg="black")
frame_buttons2.place(x=620, y=(image_height_main - IMG_HEIGHT) // 1.1 + IMG_HEIGHT + 20)  # Increase space below small image 2

# Button 2: Explore Sorting Algorithms
button2 = tk.Button(frame_buttons2, text="Explore Sorting Algorithms", width=25, height=2, command=button_click2,
                    font=("Helvetica", 15, "bold"), bg="#FFE79E", fg="black")
button2.pack()

# Load the small image 3
image_path_small3 = resource_path("small_img3.png")
# image_path_small3 = "C:\\Users\\HP\\OneDrive\\Desktop\\algo_visualizer\\GUI\\small_img3.jpeg"
image_small3 = Image.open(image_path_small3)
image_width_small3, image_height_small3 = image_small3.size

image_small3 = image_small3.resize((IMG_WIDTH, IMG_HEIGHT), Image.LANCZOS)

# Create a photoimage object of the small image 3
image_tk_small3 = ImageTk.PhotoImage(image_small3)

# Create a label widget to display the small image 3 with border
label_small_image3 = tk.Label(root, image=image_tk_small3, bg="black", highlightthickness=3, highlightbackground="white")
label_small_image3.place(x=1030, y=(image_height_main - IMG_HEIGHT) // 1.1)  # Adjust position above button 3

# Frame for the second button (Explore Sorting Algorithms)
frame_buttons3 = tk.Frame(root, bg="black")
frame_buttons3.place(x=1029, y=(image_height_main - IMG_HEIGHT) // 1.1 + IMG_HEIGHT + 20)  # Increase space below small image 2

# Button 2: Explore Sorting Algorithms
button3 = tk.Button(frame_buttons3, text="Explore Scheduling Algorithms", width=25, height=2, command=button_click3,
